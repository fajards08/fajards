...
<body style="background-color: #B6B6B4;">
  ...
  <div class="container">
    <div class="content">
      <div class="card bg-secondary-subtle" style="margin-top: 1rem;">
        <div class="row">
          <div class="col m-3">
            ...
            <p class="mt-3">Sudah memiliki akun? <a href="index.php" class="btn btn-warning text-white">Login</a></p>
          </div>
          <div class="col">
            <img src="assets/img/register.png" width="500" alt="">
          </div>
        </div>
      </div>
    </div>
